...
!
      ...
      TEXTPR (30) = 'MAX SCA FLOWRATEM2/S            '
      ...
      TEXTPR (41) = 'O2 SAT CONC     MGO2/L          '
      TEXTPR (42) = 'O2 SAT PERC     PERCENT         '
!
!-----------------------------------------------------------------------
!
!  FRANCAIS OU AUTRE
...
!
      ...
      TEXTE (41) = 'CONC SAT O2     MGO2/L          '
      TEXTE (42) = 'POURCENT SAT O2 PERCENT         '
!
...
!
      ...
      TEXTPR (41) = 'CONC SAT O2     MGO2/L          '
      TEXTPR (42) = 'POURCENT SAT O2 PERCENT         '
      ENDIF
!
!-----------------------------------------------------------------------
!
