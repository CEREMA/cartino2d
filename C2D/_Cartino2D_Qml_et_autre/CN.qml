...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" version="3.10.2-A Coruña" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" minScale="1e+08" simplifyDrawingHints="1" labelsEnabled="0" simplifyLocal="1">
  <flags>
  ...
  <aliases>
    <alias field="contour_CN" name="" index="0"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default expression="" field="contour_CN" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint field="contour_CN" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" field="contour_CN" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      <column width="-1" name="contour_CN" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="contour_CN" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="contour_CN" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
  <previewExpression>contour_CN</previewExpression>
  <mapTip></mapTip>
